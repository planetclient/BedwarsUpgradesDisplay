...
JNIEXPORT jlong JNICALL Java_io_github_planetclient_bwupgradesdisplay_utils_cursors_Win32SystemCursors_nGetDefaultCursorHandle(
...
JNIEXPORT void JNICALL Java_io_github_planetclient_bwupgradesdisplay_utils_cursors_Win32SystemCursors_nSetCursor(
